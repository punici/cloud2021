package com.punici.cloud.model.payment8005.config;
...
public class SwaggerConfig
{
    ...
    public Docket createAdminApi()
    {
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo())
                ...
                // 扫描的路径包
                .apis(RequestHandlerSelectors.basePackage("com.punici.cloud.com.punici.cloud.payment.hystrix.config.controller"))
